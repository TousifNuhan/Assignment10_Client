    ...
    <div className="w-11/12 mx-auto">
      ...
      <div className="grid grid-cols-3 gap-5 my-20">
        <div className="relative col-span-2 overflow-hidden">
          ...
          <h1 className="absolute z-20 top-3/4 text-4xl ml-14 mt-14 text-white">Qatar</h1>

          <img className="z-0 hover:transition hover:ease-in-out hover:duration-150 hover:scale-105 " src="https://images.unsplash.com/photo-1669300884869-e6e11c67c031?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
        </div>
        ...
        <div className="relative overflow-hidden">
          <h1 className="absolute z-20 top-3/4 text-4xl ml-7  text-white">Uzbekistan</h1>
